...
int main()
{
    ...
    {
    bool masks[simd_mask::SimdLen]{false, false, false, true, false, false, false, true};
   ...
   {
    simd_mask::simd_typef masks = _mm256_set_ps(-1.0f, 0.0f, 1.0f, 0.01f, -1.0f, 0.0f, 1.0f, 0.01f);
    simd_mask mask{masks};
    std::cout << "Print Simd Mask\n";
    std::cout << mask << "\n\n";
    std::cout << "Print Simd Mask count\n";
