...
T1 ANDBits(const T2 &a, const T3 &b);
template <typename T1, typename T2 = T1, typename T3 = T1>
T1 ORBits(const T2 &a, const T3 &b);
template <typename T1, typename T2 = T1, typename T3 = T1>
T1 XORBits(const T2 &a, const T3 &b);
template <typename T1, typename T2 = T1> T1 NOTBits(const T2 &a);
...
template <typename T1, typename T2> void insert(T1& val_simd, int index, const T2 &val);
template <typename T1, typename T2 = T1>
T1 shiftLLanes(int n, const T2 &val_simd);
template <typename T1, typename T2 = T1>
T1 shiftRLanes(int n, const T2 &val_simd);
template <typename T1, typename T2 = T1>
T1 rotate(int n, const T2 &val_simd);
